# Generated by Django 3.1.6 on 2021-02-04 09:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(max_length=240, verbose_name='Caption')),
                ('satisfactory', models.BooleanField(default=True, verbose_name='Satisfactory')),
                ('corrected_text', models.CharField(blank=True, max_length=240, verbose_name='Corrected Caption')),
